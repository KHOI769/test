...
# Chức năng đối sánh từ gần nhất
def closeMatches(word,patterns):
    ...
    try:
        ...
        write_to_text.write("Chatbot: Ý bạn là "+ str(sw) +" ?[Yes/No]" + " \n ")
        print("Chatbot: Ý bạn là"+ str(sw) +" ?[Yes/No]")
        C_input = Check_isEmpty("Chatbot:Ý bạn là "+ str(sw) +" ?[Yes/No]", input("Customer: "))
...
# Nhận Thông tin về xe tải và mô hình của chúng
